...
function ToolBarButtonComponent_ng_template_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtemplate(3, ToolBarButtonComponent_ng_template_2_kendo_icon_wrapper_3_Template, 1, 3, "kendo-icon-wrapper", 9)(4, ToolBarButtonComponent_ng_template_2_span_4_Template, 2, 1, "span", 10);
    ɵɵelementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = ɵɵnextContext();
...
function ToolBarButtonComponent_ng_template_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = ɵɵgetCurrentView();
    ɵɵelementStart(0, "button", 6, 5);
    ɵɵlistener("click", function ToolBarButtonComponent_ng_template_4_Template_button_click_0_listener($event) {
      ɵɵrestoreView(_r4);
      const ctx_r1 = ɵɵnextContext();
      return ɵɵresetView(ctx_r1.click.emit($event));
    })("pointerdown", function ToolBarButtonComponent_ng_template_4_Template_button_pointerdown_0_listener($event) {
      ɵɵrestoreView(_r4);
      const ctx_r1 = ɵɵnextContext();
      return ɵɵresetView(ctx_r1.pointerdown.emit($event));
    })("selectedChange", function ToolBarButtonComponent_ng_template_4_Template_button_selectedChange_0_listener($event) {
      ɵɵrestoreView(_r4);
      const ctx_r1 = ɵɵnextContext();
      return ɵɵresetView(ctx_r1.selectedChangeHandler($event));
    })("blur", function ToolBarButtonComponent_ng_template_4_Template_button_blur_0_listener() {
      ɵɵrestoreView(_r4);
      const ctx_r1 = ɵɵnextContext();
      return ɵɵresetView(ctx_r1.onBlur());
    });
...
function ToolBarButtonGroupComponent_ng_template_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtemplate(2, ToolBarButtonGroupComponent_ng_template_0_button_2_Template, 2, 14, "button", 7);
    ɵɵelementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = ɵɵnextContext();
...
function ToolBarButtonGroupComponent_ng_template_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtemplate(2, ToolBarButtonGroupComponent_ng_template_4_button_2_Template, 2, 14, "button", 7);
    ɵɵelementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = ɵɵnextContext();
...
function ToolBarDropDownButtonComponent_ng_template_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = ɵɵnextContext();
    ɵɵproperty("icon", ctx_r1.toolbarOptions.icon)("iconClass", ctx_r1.toolbarOptions.iconClass)("svgIcon", ctx_r1.toolbarOptions.svgIcon)("imageUrl", ctx_r1.toolbarOptions.imageUrl)("arrowIcon", ctx_r1.arrowIcon)("buttonClass", ctx_r1.buttonClass)("disabled", ctx_r1.disabled)("tabIndex", -1)("data", ctx_r1.data)("buttonAttributes", ɵɵpureFunction1(15, _c23, ctx_r1.title))("textField", ctx_r1.textField)("popupSettings", ctx_r1.popupSettings)("fillMode", ctx_r1.fillMode)("themeColor", ctx_r1.fillMode ? ctx_r1.themeColor : null);
    ɵɵadvance(2);
    ɵɵtextInterpolate1(" ", ctx_r1.toolbarOptions.text, " ");
  }
}
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    consts: () => {
      ...
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        const MSG_C__USERS_THOUS_DOWNLOADS_PORTFOLIO_ANGULAR_PORTI_PORTFOLIO_NODE_MODULES__PROGRESS_KENDO_ANGULAR_TOOLBAR_FESM2022_PROGRESS_KENDO_ANGULAR_TOOLBAR_MJS_0 = goog.getMsg("More tools");
        i18n_0 = MSG_C__USERS_THOUS_DOWNLOADS_PORTFOLIO_ANGULAR_PORTI_PORTFOLIO_NODE_MODULES__PROGRESS_KENDO_ANGULAR_TOOLBAR_FESM2022_PROGRESS_KENDO_ANGULAR_TOOLBAR_MJS_0;
      } else {
        i18n_0 = $localize`:kendo.toolbar.moreToolsTitle|The title of the **more tools** button in a responsive ToolBar:More tools`;
      }
      let i18n_1;
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        const MSG_C__USERS_THOUS_DOWNLOADS_PORTFOLIO_ANGULAR_PORTI_PORTFOLIO_NODE_MODULES__PROGRESS_KENDO_ANGULAR_TOOLBAR_FESM2022_PROGRESS_KENDO_ANGULAR_TOOLBAR_MJS_1 = goog.getMsg("Scroll left");
        i18n_1 = MSG_C__USERS_THOUS_DOWNLOADS_PORTFOLIO_ANGULAR_PORTI_PORTFOLIO_NODE_MODULES__PROGRESS_KENDO_ANGULAR_TOOLBAR_FESM2022_PROGRESS_KENDO_ANGULAR_TOOLBAR_MJS_1;
      } else {
      ...
      let i18n_2;
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        const MSG_C__USERS_THOUS_DOWNLOADS_PORTFOLIO_ANGULAR_PORTI_PORTFOLIO_NODE_MODULES__PROGRESS_KENDO_ANGULAR_TOOLBAR_FESM2022_PROGRESS_KENDO_ANGULAR_TOOLBAR_MJS_2 = goog.getMsg("Scroll right");
        i18n_2 = MSG_C__USERS_THOUS_DOWNLOADS_PORTFOLIO_ANGULAR_PORTI_PORTFOLIO_NODE_MODULES__PROGRESS_KENDO_ANGULAR_TOOLBAR_FESM2022_PROGRESS_KENDO_ANGULAR_TOOLBAR_MJS_2;
      } else {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ToolBarComponent, [{
    ...
    `,
      standalone: true,
      imports: [NgTemplateOutlet, LocalizedToolbarMessagesDirective, NgForOf, ToolBarRendererComponent, NgIf, ButtonComponent, NgClass, ResizeSensorComponent, ButtonGroupComponent, ToolbarScrollableButtonComponent]
    }]
  }], function() {
    return [{
      type: LocalizationService
...
var ToolBarButtonComponent = class _ToolBarButtonComponent extends ToolBarToolComponent {
  ...
  static ɵfac = function ToolBarButtonComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _ToolBarButtonComponent)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(NgZone));
  };
  static ɵcmp = ɵɵdefineComponent({
    ...
    template: function ToolBarButtonComponent_Template(rf, ctx) {
      if (rf & 1) {
        ɵɵtemplate(0, ToolBarButtonComponent_ng_template_0_Template, 3, 18, "ng-template", null, 0, ɵɵtemplateRefExtractor)(2, ToolBarButtonComponent_ng_template_2_Template, 5, 8, "ng-template", null, 1, ɵɵtemplateRefExtractor)(4, ToolBarButtonComponent_ng_template_4_Template, 3, 18, "ng-template", null, 2, ɵɵtemplateRefExtractor);
      }
    },
...
var ToolBarButtonGroupComponent = class _ToolBarButtonGroupComponent extends ToolBarToolComponent {
  ...
  static ɵfac = function ToolBarButtonGroupComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _ToolBarButtonGroupComponent)(ɵɵdirectiveInject(LocalizationService));
  };
  static ɵcmp = ɵɵdefineComponent({
    ...
    decls: 6,
    vars: 0,
    consts: [["toolbarTemplate", ""], ["popupTemplate", ""], ["sectionTemplate", ""], ["toolbarButtonGroup", ""], ["listItem", ""], ["sectionButtonGroup", ""], [3, "navigate", "focus", "tabIndex", "selection", "disabled", "width"], ["kendoButton", "", "type", "button", 3, "ngStyle", "ngClass", "disabled", "togglable", "selected", "fillMode", "themeColor", "icon", "iconClass", "svgIcon", "imageUrl", "click", "pointerdown", "selectedChange", 4, "ngFor", "ngForOf"], ["kendoButton", "", "type", "button", 3, "click", "pointerdown", "selectedChange", "ngStyle", "ngClass", "disabled", "togglable", "selected", "fillMode", "themeColor", "icon", "iconClass", "svgIcon", "imageUrl"], ["tabindex", "-1", "role", "menuitem", "class", "k-item k-menu-item", 3, "k-disabled", "ngStyle", "ngClass", "click", 4, "ngFor", "ngForOf"], ["tabindex", "-1", "role", "menuitem", 1, "k-item", "k-menu-item", 3, "click", "ngStyle", "ngClass"], [1, "k-link", "k-menu-link"], [3, "name", "customFontClass", "svgIcon", 4, "ngIf"], ["class", "k-menu-link-text", 4, "ngIf"], [3, "name", "customFontClass", "svgIcon"], [1, "k-menu-link-text"]],
...
var ToolBarDropDownButtonComponent = class _ToolBarDropDownButtonComponent extends ToolBarToolComponent {
  ...
  static ɵfac = function ToolBarDropDownButtonComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _ToolBarDropDownButtonComponent)(ɵɵdirectiveInject(NgZone), ɵɵdirectiveInject(Renderer2));
  };
  static ɵcmp = ɵɵdefineComponent({
    ...
    decls: 6,
    vars: 0,
    consts: [["toolbarTemplate", ""], ["popupTemplate", ""], ["sectionTemplate", ""], ["toolbarDropDownButton", ""], ["listItem", ""], ["sectionDropDownButton", ""], [3, "open", "close", "itemClick", "icon", "iconClass", "svgIcon", "imageUrl", "arrowIcon", "buttonClass", "disabled", "tabIndex", "data", "buttonAttributes", "textField", "popupSettings", "fillMode", "themeColor"], ["tabindex", "-1", "role", "menuitem", 1, "k-item", "k-menu-item", "k-disabled", 3, "ngClass"], [3, "ngClass"], [3, "name", "customFontClass", "svgIcon", 4, "ngIf"], ["class", "k-menu-link-text", 4, "ngIf"], [4, "ngFor", "ngForOf"], [3, "name", "customFontClass", "svgIcon"], [1, "k-menu-link-text"], ["tabindex", "-1", "role", "menuitem", 1, "k-item", "k-menu-item", 3, "click"], [1, "k-link", "k-menu-link", 3, "ngClass"]],
    template: function ToolBarDropDownButtonComponent_Template(rf, ctx) {
      if (rf & 1) {
        ɵɵtemplate(0, ToolBarDropDownButtonComponent_ng_template_0_Template, 3, 17, "ng-template", null, 0, ɵɵtemplateRefExtractor)(2, ToolBarDropDownButtonComponent_ng_template_2_Template, 5, 6, "ng-template", null, 1, ɵɵtemplateRefExtractor)(4, ToolBarDropDownButtonComponent_ng_template_4_Template, 3, 17, "ng-template", null, 2, ɵɵtemplateRefExtractor);
      }
    },
...
var ToolBarSplitButtonComponent = class _ToolBarSplitButtonComponent extends ToolBarToolComponent {
  ...
  static ɵfac = function ToolBarSplitButtonComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _ToolBarSplitButtonComponent)();
  };
  static ɵcmp = ɵɵdefineComponent({
    ...
    decls: 6,
    vars: 0,
    consts: [["toolbarTemplate", ""], ["popupTemplate", ""], ["sectionTemplate", ""], ["toolbarSplitButton", ""], ["overflowMainButton", ""], ["listItem", ""], ["sectionSplitButton", ""], [1, "k-toolbar-split-button", 3, "buttonClick", "open", "close", "itemClick", "data", "text", "icon", "iconClass", "svgIcon", "imageUrl", "buttonClass", "arrowButtonClass", "arrowButtonIcon", "arrowButtonSvgIcon", "disabled", "tabIndex", "textField", "popupSettings", "fillMode", "themeColor"], ["tabindex", "-1", "role", "menuitem", 1, "k-item", "k-menu-item", 3, "click", "ngClass"], [3, "ngClass"], [3, "name", "customFontClass", "svgIcon", 4, "ngIf"], ["class", "k-menu-link-text", 4, "ngIf"], [4, "ngFor", "ngForOf"], [3, "name", "customFontClass", "svgIcon"], [1, "k-menu-link-text"], ["tabindex", "-1", "role", "menuitem", 1, "k-item", "k-menu-item", 3, "click"], [1, "k-link", "k-menu-link"]],
    template: function ToolBarSplitButtonComponent_Template(rf, ctx) {
      if (rf & 1) {
        ɵɵtemplate(0, ToolBarSplitButtonComponent_ng_template_0_Template, 2, 16, "ng-template", null, 0, ɵɵtemplateRefExtractor)(2, ToolBarSplitButtonComponent_ng_template_2_Template, 6, 8, "ng-template", null, 1, ɵɵtemplateRefExtractor)(4, ToolBarSplitButtonComponent_ng_template_4_Template, 2, 16, "ng-template", null, 2, ɵɵtemplateRefExtractor);
      }
    },
...
//# sourceMappingURL=chunk-JNP33XZL.js.map
